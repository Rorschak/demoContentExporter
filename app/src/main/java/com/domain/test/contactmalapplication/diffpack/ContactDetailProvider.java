package com.domain.test.contactmalapplication.diffpack;
...
public class ContactDetailProvider extends ContentProvider {
    static final String PROVIDER_NAME = "com.domain.test.contactmalapplication.diffpack.ContactDetailProvider";
    ...
    static final String DATABASE_NAME = "allcontact";
    static final String CONTACTS_TABLE_NAME = "tablecontacts";
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)){
             ...
             */
            case CONTACTS:
                return "com.domain.test.cursor.dir/com.domain.test.contacts";
            /**
             * Get a particular student
             */
            case CONTACT_ID:
                return "com.domain.test.cursor.item/com.domain.test.contacts";
            default:
